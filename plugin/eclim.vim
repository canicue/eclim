...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/media/sda6/IDES/Eclipses/eclipse-SDK-3.7.2-linux-gtk/eclipse/plugins/org.eclim_1.7.2'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/media/sda6/IDES/Eclipses/eclipse-SDK-3.7.2-linux-gtk/eclipse'
  if has('win32unix')
